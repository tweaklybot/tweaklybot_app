...
@Serializable
data class CreateRepoRequest(val repoName: String? = null)
...
data class UploadResponse(
    val success: Boolean,
    val content: UploadContentData? = null,
    val message: String? = null
)
...
data class DeleteFileRequest(
    val path: String,
    val sha: String,
    val commitMessage: String = "Delete via Tweakly"
)
